...
if (isset($_POST['email_address']) && isset($_POST['password']))
{
    ...
    $query = "select * from admin where admin.email_address='$email_address'and admin.password='$password'"; 
...
<?php
    ...
    { 
        echo "<div class='logout'><a class='logoutbutton' href='logout.php'>Log out</a></div>";
    }
